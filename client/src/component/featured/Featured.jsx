		...
		<div className='w-full  flex justify-between gap-5 z-0 '>
			<div className='relative text-lime-50 border rounded-lg overflow-hidden h-auto lg:h-80'>
				...
				<div className='absolute bottom-5 left-5'>
					...
					'>Dublin</h1>
					<h1 className='text-2xl font-semibold'>123 properties</h1>
				</div>
			</div>
			<div className='relative text-lime-50 border rounded-lg overflow-hidden h-auto lg:h-80'>
				...
				<div className='absolute bottom-5 left-5'>
					<h1 className='text-4xl font-bold
					'>Reno</h1>
					<h1 className='text-2xl font-semibold'>533 properties</h1>
				</div>
			</div>
			<div className='relative text-lime-50 border rounded-lg overflow-hidden h-auto lg:h-80'>
				...
				<div className='absolute bottom-5 left-5'>
					<h1 className='text-4xl font-bold
					'>Austin</h1>
					<h1 className='text-2xl font-semibold'>532 properties</h1>
				</div>
			</div>
		</div>
	)
